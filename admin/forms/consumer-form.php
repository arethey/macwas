<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input required pattern="[9][0-9]{9}" aria-describedby="phone" required type="text" name="phone" class="form-control <?php echo (!empty($phone_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $phone; ?>">
